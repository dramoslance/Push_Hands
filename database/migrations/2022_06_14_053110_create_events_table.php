...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->string('start_time')->comment('This is the Event start time');
            $table->string('end_time')->comment('This is the Event termination time.');
            ...
            $table->integer('status')->comment('Let us know if an event is in the following states: 0 = draft,1 = pusblished')->nullable();
