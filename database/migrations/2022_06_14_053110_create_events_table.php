...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('events', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('organizer_id')->comment('The organizer identifies to whom the event belongs');
            $table->unsignedBigInteger('location_id')->comment('The Location identifies of the event event');
            $table->unsignedBigInteger('cluster_id')->comment('The cluster identifies that groups the event');
            $table->unsignedBigInteger('event_id')->comment('"The identifies of the father event, that is, when an event is organized in a recurring way.The father event will have null value in this field')->nullable();
