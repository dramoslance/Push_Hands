...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('site_logs', function (Blueprint $table) {
            ...
            $table->timestamp('start_time')->comment('The time in which entry into the log is created')->useCurrent();
            $table->timestamp('end_time')->comment('The time in which a user leaves an event or activity')->useCurrent();
